		...
		<div style="width: 100%; padding-top: 10px; background-color: #F9F9F9;">
			...
			<div>
				<p style="width: 100%; height: 45px; margin-top: 6px;">
					<span style="width: 160px; height: 45px; line-height: 45px; color: #4C4C4C; float: left; font-family: Arial; font-size: 40px; font-weight: 700;">Ka账户:</span>
				...
				<p style="width: 100%; height: 45px; margin-top: 6px; margin-bottom: 6px;">
					<span style="width: 160px; height: 45px; line-height: 45px; float: left; color: #4C4C4C; font-family: Arial; font-size: 40px; font-weight: 700;">金额:</span>
					<input type="text" maxlength="16" style="width: 380px; height: 45px; line-height: 45px; color: #4C4C4C; font-family: Arial; font-size: 40px; font-weight: 700;"/>元
				</p>
				<div style="padding: 20px 15px; background-color: rgb(244, 246, 252);">
					<input type="button" value="转账" style="height: 31px;"/>(大写：******圆*角*分)
				</div>
			</div>
		</div>
	</div>
