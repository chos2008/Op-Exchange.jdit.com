...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" style="margin: 0px; padding: 0px;">
	...
	<div style="width: 100%;">
	<div style="width: 990px; height: inherit; line-height: 26px; margin: 0px auto;">
	<div style="display: block; border: 1px solid #d3d3d3; margin: 0px 0px;">
	...
	<div style="width: 100%; margin-top: 10px;">
		<div style="border: 1px solid #ccc; margin: 0px 0px;">
			<div style="height: 14px; line-height: 16px; padding: 9px 10px;; background-color: rgb(239, 240, 241); font-family: tahoma, arial, 'Hiragino Sans GB', 'Microsoft Yahei', 宋体;">
				<h3 style="display: inline;">最近交易</h3>
			...
			<div style="width: 100%;">
				<table style="width: 100%; border-spacing: 0; border-collapse: collapse;">
				    ...
				    <#if i % 2 != 0>
				    	<#assign backgroundColor ='background-color: rgb(251, 251, 251);' />
				    </#if>
				    <tr style="line-height: 1.5; color: gray; ${backgroundColor}">
				    	<td style="width: 60px; line-height: 1.5; border-bottom: 1px solid #e6e6e6;">${student.timestamp?string("yyyy-MM-dd HH:mm:ss")}</td>
				    	<td style="line-height: 1.5; word-break: break-all; word-wrap: break-word; border-bottom: 1px solid #e6e6e6;">${student.item?if_exists}</td>
				    	<td style="line-height: 1.5; border-bottom: 1px solid #e6e6e6;">//${student.amount?if_exists}//</td>
				    	<td style="line-height: 1.5; border-bottom: 1px solid #e6e6e6;">${student.status?if_exists}</td>
				    	<td style="line-height: 1.5; border-bottom: 1px solid #e6e6e6;">${student.tsn?if_exists}/${i}</td>
				    </tr>
				    <#assign i =i + 1 />
				    </#list>
				</table>
